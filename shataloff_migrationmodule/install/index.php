...
Class shataloff_migrationmodule extends CModule{
	var	$MODULE_ID = 'shataloff_migrationmodule';
	var $MODULE_VERSION;
	...
	function __construct(){
		...
		$this->MODULE_NAME = Loc::getMessage("SHATALOFF_MIGRATIONMODULE_MODULE_NAME");
		$this->MODULE_DESCRIPTION = Loc::getMessage("SHATALOFF_MIGRATIONMODULE_MODULE_DESC");

		$this->PARTNER_NAME = getMessage("SHATALOFF_MIGRATIONMODULE_PARTNER_NAME");
		$this->PARTNER_URI = getMessage("SHATALOFF_MIGRATIONMODULE_PARTNER_URI");
	...
	function DoInstall(){
		...
		if ($this->isVersionD7()){
			...
			$APPLICATION->ThrowException(Loc::getMessage("SHATALOFF_MIGRATIONMODULE_INSTALL_ERROR_VERSION"));
		}

		$APPLICATION->IncludeAdminFile(Loc::getMessage("SHATALOFF_MIGRATIONMODULE_INSTALL"), $this->GetPath()."/install/step.php");
	}
	...
	function DoUninstall(){
		...
		$APPLICATION->IncludeAdminFile(Loc::getMessage("SHATALOFF_MIGRATIONMODULE_UNINSTALL"), $this->GetPath()."/install/unstep.php");
	}
}
?>